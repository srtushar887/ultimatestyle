...
@section('user')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form class="needs-validation" novalidate="" action="{{route('user.profile.update')}}" method="post" enctype="multipart/form-data" name="useprofilefrm">
                        @csrf
                        <div class="form-row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="zip_code" value="{{Auth::user()->zip_code}}" class="form-control" >
                            </div>
    ...
    <script>
        document.forms['useprofilefrm'].elements['country'].value={{Auth::user()->country}}
    </script>
@stop
