                                ...
                                <div class="sidebar-widget-body" style="height: 333px;overflow: scroll;">
                                    @foreach($top_cats as $tcat)
                                        <div class="checkbox" style="margin-left: 20px;">
                                            <input type="radio" class="common_selector main_category" id="attribute_1_value_{{$tcat->id}}"  name="maincategory" value="{{$tcat->id}}">
                                ...
                                <div class="sidebar-widget-body">
                                    <div class="compare-report subcatdata" style="height: 333px;overflow: scroll;">
                                        @foreach($mid_cats as $mcat)
                                            <div class="checkbox" style="margin-left: 20px;">
                                                <input type="radio" class="common_selector mid_category" id="attribute_2_value_{{$mcat->id}}" {{$cat_id == $mcat->id ? 'checked' : ''}} name="midcategory" value="{{$mcat->id}}">
...
@section('js')
    <script>
        ...
        $(document).ready(function (){
            ...
            var mid =$('.mid_category:checked').val();
            $.ajax({
                type : "POST",
                url: "{{route('get.subsubcat')}}",
                data : {
